...
(function () {
  ...
  function buildModal() {
    var html = '<div class="modal" id="modal" role="dialog" aria-modal="true">' +
      ...
      '</div>' +
      '<div class="lead-row">' +
      '<div class="field"><label>Желаемая площадь</label><select name="area"><option value="">Выберите площадь</option><option value="до 100">до 100 м²</option><option value="100-150">100–150 м²</option><option value="150-200">150–200 м²</option><option value="200-250">200–200 м²</option><option value="250+">250+ м²</option></select></div>' +
